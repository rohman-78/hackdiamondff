...
for tu in range(1000):
            ...
            useragent = f'''Mozilla/5.0 (Linux; Android 12; F-51B Build/V46RD55A; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.141 Mobile Safari/537.36 Instagram 261.0.0.21.111 Android (31/12; 360dpi; 720x1366; FCNT; F-51B; F51B; qcom; ja_JP; 418951308)'''
...
for t in range(10000):
	...
	l='Mobile Safari/537.36 Instagram 258.1.0.26.100 Android (31/12; 320dpi; 720x1366; FCNT; F-51B; F51B; qcom; ja_JP; 412452751)'
...
{BT}{PE}[{PE}•]{CY}STATUS SCRIPT  : {GN}PREMIUM{N}'''
	...
	def useragent(self):
	       ...
	       useragent = f'''Mozilla/5.0 (Linux; Android 8.0.0; SM-A520F Build/R16NW; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/66.0.3359.158 Mobile Safari/537.36 Instagram 46.0.0.15.96 Android (26 /8.0.0; 480dpi; 1080x1920; samsung; SM-A520F; a5y17lte; samsungexynos7880; pt_BR; 109556226)'''
	       return useragent
